...
public class Admin_duty implements Serializable{
	...
	public Admin_duty(int admin_authority, String duty_publish_grade, Timestamp duty_publish_time,
			String duty_publish_info, boolean duty_publish_state) {
		super();
